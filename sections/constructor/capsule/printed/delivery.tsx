    ...
    <section className="bg-constructor-gray relative flex min-h-[calc(100svh-98px)] flex-col items-center overflow-clip pb-40">
      ...
      <form className="w-full max-w-738 px-16">
        <div className="relative mt-108 flex h-334 flex-col justify-end gap-12 rounded-[44px] bg-white px-16 pb-32 md:mt-226 md:grid md:h-281 md:grid-cols-2 md:items-end md:px-90">
          <div className="absolute top-20 left-1/2 -translate-x-[calc(50%-104px)] -translate-y-1/2 md:-top-10">
            <Card className="shadow-delivery-card absolute -top-58 -left-176 h-auto w-227 -rotate-7 md:w-300" illustration={illustration} images={images} message={message} />
            <Image className="shadow-delivery-card object-cover" src="/printed-envelope.png" alt="" width="344" height="223" />
            <Image className="absolute top-120 -right-106 -translate-y-full md:top-75 md:-right-50" src="/postmark.png" alt="" width="184" height="120" />
          </div>
          ...
          <Radio
            ...
            title="Schedule send"
            subtitle="at least 10 days from today"
            value="delayed"
